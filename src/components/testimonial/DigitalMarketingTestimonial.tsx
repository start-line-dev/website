    ...
    const testimonials = [
        {
            id: 1,
            quoteSvg: <QuoteIcon />,
            text: "Nous vous aiderons à identifier votre marché cible, à développer un plan marketing et à développer votre base de clients. Nous nous engageons à vous aider à réussir et nous travaillerons avec vous à chaque étape.",
            authorImg: authorImg,
            logo: testiLogo,
                ...
                <div className="row justify-content-center">
                    <div className="offset-xl-6 col-xl-6 col-lg-8 col-md-9">
                        <div className="dgm-testimonial-title-box text-center z-index-1 mb-45">
                            <span className="tp-section-subtitle subtitle-grey mb-15 tp_fade_anim" data-delay=".3">Témoignages</span>
